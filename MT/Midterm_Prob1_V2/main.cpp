/*midterm Problem 1_V2
 allocates emory but has to create a new variable to do it--dont think it is 
 actually saving inputted information and putting them into an array of 
 * structures*/
