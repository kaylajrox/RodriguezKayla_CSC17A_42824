/*midterm Problem 1_V1
 Does not include the dynamic allocation of the structures yet*/
...
struct Cstmr{
    ...
    float balB;//balance at the begining of the month
...
int main(int argc, char** argv){
    //Declare Variables
    Cstmr cInfo; //customer information
//    cInfo=new Cstmr[];
...
void input(Cstmr &cInfo){ 
    ...
    cin>>cInfo.accNum;
        if(cInfo.accNum.length()!=5){
            cout<<"Your accout number needs to be five digits"<<endl;
        }
    }while(cInfo.accNum.length()!=5);
    cout<<"Enter your balance at the begining of the month "<<endl;
    cin>>cInfo.balB;
