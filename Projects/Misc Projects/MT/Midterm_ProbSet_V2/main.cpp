...
////////////////////////////////////////////////////////////////////////////////
 statsResult printStat(int *array,int size,statsResult *data) {
    ...
    if (data->nModes>1){
        cout<<"The modes are: "<<data->mode;
    }else {
        cout<<"The mode is "<<data->mode;
    }
    //Display Median
    cout<<"\nThe median is ";
    cout<<data->median;
...
void problem5(){
        ...
        cout<<"The largest factorial that a data type can hold. "<<endl;
        cout<<"char (unsigned or signed)          n=3\n";
        cout<<"unsigned short                     n=8\n";
        cout<<"short                              n=7\n";
        cout<<"unsigned int                       n=12\n";
        cout<<"int                                n=12\n";
        cout<<"unsigned long                      n=20\n";
        cout<<"long                               n=20\n";
        cout<<"float                              n=34\n";
        cout<<"double                             n=170\n";
}
...
void problem6(){
    ...
    cout<<"Part a "<<endl;   
    cout<<"2.125 converted to binary is 0010.0010"<<endl;
    ...
    cout<<"in hex .22"<<endl;
    cout<<"Part b "<<endl;
     cout<<"-2.125 converted to binary is 1010.1110"<<endl;
    cout<<"in octal is 5.6"<<endl;
    cout<<"in base hex 5.C"<<endl; 
    cout<<"Part c "<<endl;
    cout<<"46666601 converted to decimal representation is .8CCCCCC "<<endl;
    cout<<"46666602 converted to decimal representation is  1.1999999"<<endl;
    cout<<"B9999AFE converted to decimal representation is -.2333328"<<endl;
    cout << "a)\n";
